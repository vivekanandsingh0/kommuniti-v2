-- Volunteer page CMS — run after about_schema.sql
...
-- Role field on application form (options synced from volunteer_roles in app; placeholder for admin visibility)
INSERT INTO volunteer_form_fields (sort_order, field_key, label, field_type, placeholder, is_required, options)
SELECT 4, 'volunteer_role', 'Preferred volunteer role', 'select', NULL, true, '[]'::jsonb
