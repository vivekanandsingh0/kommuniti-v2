      ...
      <aside className="w-64 border-r border-[rgba(201,168,76,0.1)] hidden lg:flex flex-col p-6 sticky top-0 h-screen">
        ...
        <nav className="space-y-2 flex-1">
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-sm transition-all ${window.location.pathname === '/admin/kores' ? 'bg-[rgba(201,168,76,0.1)] text-[#C9A84C]' : 'text-[rgba(240,232,213,0.3)] hover:bg-white/5 hover:text-[#F0E8D5]'}`}
          >
            <CircleDot size={18} />
